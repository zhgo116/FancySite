package cn.fancy.mybatis.provider;
...
import cn.fancy.constant.Constant;
import cn.fancy.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            cn.fancy.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(cn.fancy.mybatis.EntityHelper.getAllColumns(entityClass));
